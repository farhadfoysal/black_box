...
class TutorStudent {
  ...
  TutorStudent({
    ...
    required String gaurdianPhone,
    required String phonePass,
    required String dob,
    required String education,
    required String address,
    required int activeStatus,
    required DateTime admittedDate,
    required String img,
    required List<TutorWeekDay> days,
  })  : _id = id,
        _uniqueId = uniqueId,
        _userId = userId,
        _phone = phone,
  ...
  static TutorStudent fromMap(Map<String, dynamic> map) {
    return TutorStudent(
      ...
      admittedDate: DateTime.parse(map['admitted_date'] ?? ''),
      img: map['img'] ?? '',
  ...
  factory TutorStudent.fromJson(Map<String, dynamic> json) {
    return TutorStudent(
      ...
      admittedDate: DateTime.parse(json['admitted_date'] ?? ''),
      img: json['img'] ?? '',
