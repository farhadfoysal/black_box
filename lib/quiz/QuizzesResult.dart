...
class QuizzesResultPage extends StatefulWidget {
  final String quizId; // Pass the quizId to the page

  QuizzesResultPage({required this.quizId});

  @override
  _QuizzesResultPageState createState() => _QuizzesResultPageState();
}

class _QuizzesResultPageState extends State<QuizzesResultPage> {
          ...
          IconButton(
            ...
            onPressed: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => Leaderboardresult(quizId: widget.quizId),
                ),
              );
