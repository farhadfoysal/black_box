...
class QuizResultScreen extends StatefulWidget {
  ...
  const QuizResultScreen({
    ...
    required this.selectedAnswer, required this.studentId, required this.phoneNumber, required this.quiz,
  });
...
class _QuizResultState extends State<QuizResultScreen> {
  ...
  void saveResult() async {
    ...
    try {
      ...
      await Quizfirestorehelper.saveQuizResultToFirestore(quizResult);
      print('Quiz result saved to Firestore');


      await Quizresultdbhelper.saveQuizResultToSQLite(quizResult);
