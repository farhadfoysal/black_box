...
class StudentResultsPage1 extends StatefulWidget {
  final String studentId;

  const StudentResultsPage1({
    Key? key,
    required this.studentId,
  }) : super(key: key);

  @override
  State<StudentResultsPage1> createState() => _StudentResultsPageState();
}

class _StudentResultsPageState extends State<StudentResultsPage1> {
